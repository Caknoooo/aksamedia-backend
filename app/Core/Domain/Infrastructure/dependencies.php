...
use App\Core\Domain\Infrastructure\Repository\SqlDivisionRepository;
use App\Core\Domain\Infrastructure\Repository\SqlEmployeeRepository;
...
$app->singleton(DivisionRepositoryInterface::class, SqlDivisionRepository::class);
$app->singleton(EmployeeRepositoryInterface::class, SqlEmployeeRepository::class);
